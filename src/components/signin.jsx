        ...
        return (
            <div className="login-box">
                ...
                <div style={{ padding: "10px", margin:"5px", display: "flex", flexDirection: "column", fontSize:"20px", justifyContent:"center", alignItems:"center" }}>
                     <a style={{color: CSS.secondarycolor, textDecoration:"none",  padding: "5px"}} href="/signup">Create account instead!</a>
                     <a style={{color: CSS.secondarycolor, textDecoration:"none"}} href="/resetpassword">forgot password?</a> 
                </div>
            </div>
        )
    }
